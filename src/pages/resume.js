            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                    ...
                    <Box className='card pink' sx={{ mt: "10px" }}>
                        <Typography component='h6' variant='h6' className='year'>2019 - 2022</Typography>
                        <Typography component='h6' variant='h6' className='role'>Bsc Computer Science</Typography>
                        <Typography component='h6' variant='h6' className='at'>Einstein College of Arts and Science</Typography>
                    </Box>
                    <Box className='card pink' sx={{ mt: "10px" }}>
                        <Typography component='h6' variant='h6' className='year'>2016 - 2018</Typography>
                        <Typography component='h6' variant='h6' className='role'>Math Bio</Typography>
                        <Typography component='h6' variant='h6' className='at'>Senaithalaivar Hr.Sec School</Typography>
                    </Box>
                </Grid>
                <Grid item xs={12} md={6} >
                    <Typography className='heading icon title' variant='h6' component='h6'>
                    ...
                    <Box className='card pink' sx={{ mt: "10px" }}>
                        <Typography component='h6' variant='h6' className='year'>2022 - 2023</Typography>
                        <Typography component='h6' variant='h6' className='role'>Full Stack Developer Intern</Typography>
                        <Typography component='h6' variant='h6' className='at'>Largstore Private Limited</Typography>
                    </Box>
                </Grid>
                <Grid item xs={12} md={6} >
                    ...
                    <Box sx={{ mt: "10px", display: "flex", flexWrap: "wrap" }}>
                        ...
                        <Typography className='content chip'>MySQL</Typography>
                        <Typography className='content chip'>MongoDB</Typography>
                        <Typography className='content chip'>Python</Typography>
                ...
                <Grid item xs={12} md={6} >
                    ...
                    <Box sx={{ mt: "10px", display: "flex", flexWrap: "wrap" }}>
                        ...
                        <Typography className='content chip'>Mentorship</Typography>
                    </Box>
                </Grid>
            </Grid>
