            ...
            <Grid container spacing={3}>
                <Grid item xs={12} md={6}>
                    <Box className='card pink' sx={{ mt: "10px" }}>
                        ...
                        <Typography variant='p' component='p' className='content'>&ensp; &ensp; &ensp; +91 6382306472</Typography>
                    </Box>
                </Grid>
                <Grid item xs={12} md={6}>
                    <Box className='card blue'>
                        ...
                        <Typography variant='p' component='p' className='content'>&ensp; &ensp; &ensp; puvanmani15@gmail.com</Typography>
                ...
                <Grid item xs={12} >
                    <Box className='card blue' sx={{ p: 4 }}>
                        <Typography variant='p' component='p' className='content' sx={{ mb: "15px" }}>
                            I am always open to discussing <b>new projects</b>, <b>opportunities in tech world</b>, <b>partnerships</b> and more so <b>mentorship</b>.
                        </Typography>
