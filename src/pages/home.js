            ...
            <Grid container spacing={3}>
                ...
                <Grid item xs={12} md={6}>
                    <Box className='card blue'>
                        <Typography className='heading icon title' variant='h6' component='h6'> <svg width="22" height="18" viewBox="0 0 22 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <Grid item xs={12} md={6} >
                    <Box className='card pink'>
                        <Typography className='heading icon title' variant='h6' component='h6'> <svg width="30" height="24" viewBox="0 0 30 24" fill="none" xmlns="http://www.w3.org/2000/svg">
