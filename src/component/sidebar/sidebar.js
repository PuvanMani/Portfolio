...
import PuvanResume from '../../assets/pdf/Puvan (Resume).pdf';
        ...
        <Box sx={{ width: "100%", display: "flex", flexDirection: "column", alignItems: 'center' }}>
            ...
            <Box className='smallDevice' sx={{ backgroundColor: "#FFF", width: "100%", height: { xs: "75vh", sm: "100vh", md: "75vh" }, borderRadius: "12px", pt: '20%', textAlign: "center", mt: { xs: "23%", sm: "10%", md: "30%", lg: "25%" } }}>
                ...
                <Box sx={{ justifyContent: "space-around", display: "flex", mx: { xs: "10px", md: "20px" } }}>
                    <a href='https://www.facebook.com/mrwhitespirit/' target='_blank' rel="noreferrer">
                    ...
                    <a href='https://www.linkedin.com/in/puvan-mani-46722424a/' target='_blank' rel="noreferrer">
                    ...
                    <a href='https://www.instagram.com/mr_white_spirit_/' target='_blank' rel="noreferrer">
                        <IconButton className='socialIcons' sx={{ p: { xs: "20px", md: "10px" } }}>
                    ...
                    <a href='https://github.com/PuvanMani' target='_blank' rel="noreferrer">
                ...
                <Box className='contactdetails'>
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        <Box sx={{ textAlign: "left", pl: "15px" }}>
                            ...
                            <Typography className='contactDescription content' variant='h6' component='h6'>+91 6382306472</Typography>
                        </Box>
                    </Box>
                    ...
                    <Box sx={{ display: "flex", alignItems: "center" }}>
                        ...
                        <Box sx={{ textAlign: "left", pl: "15px" }}>
                            ...
                            <Typography className='contactDescription content' variant='h6' component='h6'>puvanmani15@gmail.com</Typography>
                        </Box>
                    </Box>
                    <Divider variant="middle" />
                    <Box sx={{ display: "flex", alignItems: "center" }}>
